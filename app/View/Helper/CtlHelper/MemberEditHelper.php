 ...
 */
class MemberEditHelper extends AppCtlHelper {

	public $tbl_member_id = 0;
	
	public $member_name = '';


	public function setTblMemberId($tbl_member_id) {
		$this->tbl_member_id = $tbl_member_id;
	}
	
	public function setTblMemberName($member_name) {
	...
	public function getInputTblGroup() {
		...
		$input		= $form->input($field, $options);
	 ...
	 * @return string
	 */
	public function getValueMemberId() {
		$form		= $this->ExtForm;
		$field		= 'id';
		...
		$arrTags = array(
			'<script>(function($) {',
				"$('.bt_back').click(function(){",
					"location.href = '/MemberEdits/{$backAction}';",
					'return false;',
				'});',
			'})(jQuery)</script>',
		);
	 ...
	 * @return string
	 */
	public function getLinkMemberDetail() {
		$ctlHelper	= $this;
		$html		= $ctlHelper->Html;
		
		$tbl_member_id = $ctlHelper->tbl_member_id;
	...
	public function getLinkMemberDelete() {
		$ctlHelper	= $this;
		$form		= $ctlHelper->ExtForm;
		
		$tbl_member_id	= $ctlHelper->tbl_member_id;
		$member_name	= $ctlHelper->member_name;
